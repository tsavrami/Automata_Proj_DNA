...
public class Driver {
    public static void main(String[] args) {
        ...
        // BIG loop so another file can be chosen to analyze without restarting program
            while(true){
            try(Scanner scnr = new Scanner(System.in)) {
                ...
                while(flag){
                    ...
                    if(!choiceStr.matches("\\d+")){ // check if input is a number
                ...
                // Ask if user wants to analyze another file or exit
                System.out.print("\n>>> Do you want to analyze another file? (y/n): ");
                flag = true;
                while(flag){
                    String yn2 = scnr.nextLine();
                    if(yn2.equalsIgnoreCase("y"))
                        flag = false;
                    else if(yn2.equalsIgnoreCase("n")){
                        System.out.println("\nExiting program. Goodbye!");
                        System.exit(0); // !!! This breaks the outer while(true) loop
                    }
                    else System.out.print(">>> Invalid input. Do you want to analyze another file? (y/n): ");
                }
                System.exit(0);
            }
        }
